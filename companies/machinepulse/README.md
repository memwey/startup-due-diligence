...
- Leadership is identifiable only from LinkedIn, and only with a logged-in session: **Leah Wang**, CEO since January 2026 (ex-ByteDance Strategic Product Manager to November 2025); **Nanqun Chen**, co-founder and COO since December 2025 (ex-ByteDance, currently also listed as Lead Product Manager at StepFun); **Lucas Wu**, founding member since December 2025 (ex-Tencent, ex-Z.ai Z Fund). No name appears on any company-controlled surface.
- Karpo runs on iMessage through **Linq**'s messaging infrastructure, stated by a MachinePulse founding member and confirmed on [Linq's community page](https://linqapp.com/community).
...
| Headcount | LinkedIn band of 51–200 employees, with 17 members listing MachinePulse as their current workplace; 411 followers | [LinkedIn](https://www.linkedin.com/company/machinepulseai/about/); accessed 2026-07-29 while signed in |
| Leadership | Leah Wang (CEO), Nanqun Chen (co-founder, COO), Lucas Wu (founding member), Titus Zhai (Head of Growth) | LinkedIn profiles; see `Founder` |
...
No founder or executive is named on the corporate site, the careers page, any Karpo page, any repository, or any press release. The [GitHub organisation](https://github.com/orgs/machinepulse-ai/people) has no public members. Leadership is identifiable only from LinkedIn profiles, which require a logged-in session to read; all four below were read on 2026-07-29.

| Name | Role | Since | Location | Source |
|---|---|---|---|---|
| Leah Wang | Chief Executive Officer | Jan 2026 | North America | [LinkedIn](https://www.linkedin.com/in/leah-wang-8676903a8/) |
| Nanqun Chen | Co-Founder, COO | Dec 2025 | Singapore | [LinkedIn](https://www.linkedin.com/in/nanqunchen/) |
| Lucas Wu | Founding Member | Dec 2025 | Singapore | [LinkedIn](https://www.linkedin.com/in/fan-lucas-wu/) |
| Titus Zhai | Head of Growth | — | — | [2026-07-28 release](https://news.eandtnews.com/story/560137/karpo-crosses-half-a-million-personalized-recommendations-in-under-80-days.html) |

**Leah Wang** — Chief Executive Officer, self-described on the profile headline as "Founder". The profile lists two positions only and 20 connections.

- Aug 2023 – Nov 2025: Strategic Product Manager, ByteDance (listed region: Asia).
- Jan 2026 – present: Chief Executive Officer, MachinePulse, listed as "Self-employed", region North America.

**Nanqun Chen** — Co-Founder and COO.

- Jul 2013 – Mar 2014: Software Engineer, IBM (DevOps SaaS), Ningbo.
- Mar 2014 – Dec 2015: Product Manager, Ningbo Smarter Logistics Technology, described on the profile as the IBM Smarter Logistics Lab; SaaS platforms for chemical and cold-chain logistics.
- Jan 2016 – Aug 2017: Senior Product Manager, Shanghai Node Supply Chain Management (NodeSCM), owning a TMS/WMS platform.
- Aug 2017 – Dec 2020: Co-founder and Product Manager, Xiaobei Culture Technology (Shanghai), for the Heychat social app.
- Dec 2020 – Aug 2022: Senior Product Manager, Silot.ai, Shanghai; product owner for Kaya, a C2C e-commerce app in the Indonesian market.
- Oct 2022 – Feb 2024: Senior Product Manager, ByteDance, Shanghai.
- Apr 2024 – present: Lead Product Manager, StepFun (阶跃星辰), Shanghai. The profile still shows this as current alongside the MachinePulse role — see `Notes`.
- Dec 2025 – present: Co-Founder, MachinePulse, Singapore.

**Lucas Wu** — Founding Member; profile headline "Building proactive AI @MachinePulse, ex-Tencent, Duke Fuqua". Education listed: Duke University Fuqua School of Business.

- 2019–2021: internships at BCG, Tencent (smart retail strategy), AWS (project management), and Skyview Fund; Feb – May 2021, Monetization Product Intern at TikTok, Beijing, working on the self-serve ads platform's risk control.
- Oct 2021 – Feb 2023: Rotational Product Manager, Tencent (腾讯产培项目), Shenzhen.
- Mar 2023 – Sep 2025: Investment Manager, Skyview Fund (天善资本), Beijing; early-stage AI software/hardware and smart manufacturing.
- Sep 2025 – Dec 2025: Senior Investment Manager, Z.ai (智谱AI) Z Fund, Beijing.
- Dec 2025 – present: Founding Member, MachinePulse, Singapore.
- Jun 2020 – present: founder of a non-profit, SEA社会创新俱乐部.

### Stated team origins

Four descriptions of the team's background exist, none of them naming anyone, and they do not agree on which company the founders came from:

| Claim | Source |
|---|---|
| "Our team comes from leading AI application teams and global internet companies including TikTok, Amazon, PayPal, and Keeta" | [LinkedIn company About](https://www.linkedin.com/company/machinepulseai/about/) |
| "a stealth AI startup (founded by ex-TikTok product leaders)" | [Lucas Wu, LinkedIn post](https://www.linkedin.com/in/fan-lucas-wu/), posted around December 2025 |
| "Founded by former executives from top AI labs with deep expertise in large language models, context engineering, and multi-agent systems" | [Lucas Wu's MachinePulse role description](https://www.linkedin.com/in/fan-lucas-wu/details/experience/) |
| Mentorship "directly alongside senior practitioners with ByteDance backgrounds"; "direct access to the founding team" | [jobs API](https://join.machinepulse.ai/api/jobs) |

The two leadership profiles that list prior employers both show ByteDance: Leah Wang as Strategic Product Manager to November 2025, Nanqun Chen as Senior Product Manager to February 2024.
...
A third statement, differing in kind, is on the [LinkedIn company About page](https://www.linkedin.com/company/machinepulseai/about/) (accessed 2026-07-29): "We have secured continued backing from top-tier investors, with tens of millions of dollars in funding." The recruitment copy asserts a valuation; this one asserts an amount raised. The two are not inconsistent, but no source states both together, and neither is attached to a round or a date.

No investor is named anywhere. Nothing corroborates any of the three statements: no Crunchbase or Tracxn entry exists for the Singapore entity, and no press release, investor portfolio page, or news article mentioning a MachinePulse round was found. The Commercial Operations posting asks for candidates with "startup experience or time at an early-stage company (Series A or earlier)", which describes the candidate's background rather than the company's own stage.
...
| Karpo messaging infrastructure | [Linq](https://linqapp.com/), a communications API for iMessage, RCS, SMS and voice — "Karpo is now live on iMessage through Linq's messaging infrastructure" | Confirmed — [Lucas Wu, LinkedIn](https://www.linkedin.com/in/fan-lucas-wu/); corroborated on [Linq's community page](https://linqapp.com/community) |
...
Search scope for the findings below (2026-07-29): machinepulse.ai and every link on it; join.machinepulse.ai rendered in a browser plus its `/api/jobs` endpoint and all 20 role records; world2agent.ai including the SensorHub; app.karpo.ai including its full sitemap, FAQ, about, how-it-works, and buzz pages; the GitHub organisation via the REST API, its six repositories, and its members page; the world2agent README and architecture doc; the Shotwright README; searches in English and Chinese for "MachinePulse", "MachinePulse Pte", "Karpo", "Karpo AI", and "World2Agent"; the LinkedIn company page, its About and Jobs tabs, and the three leadership profiles including their full experience pages, all read in a signed-in browser session; Crunchbase, Tracxn, and GetLatka; uspto.report trademark listings; and searches for a Karpo App Store listing.

- No founder or executive is named on any surface the company controls — site, careers page, product pages, repositories, press releases. The names in `Founder` come from individual LinkedIn profiles, which are unreadable without a signed-in session. No team page exists on any property.
- No funding round, investor, valuation date, or database entry corroborating the company's three self-reported funding statements was found.
...
- No named individual is attached to any job posting, department, or reporting line; the postings refer to "the founding team" without naming it.
...
- Neither Leah Wang's nor Nanqun Chen's profile lists an education entry, and no profile states a founding date for the company.
...
- **Where the founders came from:** the [LinkedIn company page](https://www.linkedin.com/company/machinepulseai/about/) says TikTok, Amazon, PayPal and Keeta; a [founding member's post](https://www.linkedin.com/in/fan-lucas-wu/) says "ex-TikTok product leaders"; his [role description](https://www.linkedin.com/in/fan-lucas-wu/details/experience/) says "former executives from top AI labs"; the [job postings](https://join.machinepulse.ai/api/jobs) say ByteDance. TikTok and ByteDance are the same group, but "top AI labs" is a different claim, and no source names an individual.
- **Nanqun Chen's current employment:** his [profile](https://www.linkedin.com/in/nanqunchen/details/experience/) lists Lead Product Manager at StepFun as running from April 2024 to the present at the same time as Co-Founder at MachinePulse from December 2025 to the present (accessed 2026-07-29). Whether one entry is simply not closed out is not determinable from the profile.
- **Founding date:** the three leadership profiles date their MachinePulse roles to December 2025 and January 2026, and the GitHub organisation was created 2025-11-11; no source states when the company itself was founded or incorporated.
...
- A second hiring track exists on LinkedIn that does not appear in the careers-site API: a founding member has posted New York on-site roles for Partnership Development Manager, Social Media & Community Operations, and Community & Events Operations ([Lucas Wu, LinkedIn](https://www.linkedin.com/in/fan-lucas-wu/); accessed 2026-07-29). The `/api/jobs` feed lists only one New York role.
- Karpo is described by a founding member as "one of the fastest-growing applications on iMessage" ([LinkedIn](https://www.linkedin.com/in/fan-lucas-wu/)); this is a company claim with no supporting figure.
- The company runs on third-party messaging infrastructure it does not control: Karpo's entire delivery channel depends on [Linq](https://linqapp.com/) and, beneath it, on Apple's iMessage.
...
- LinkedIn profiles (require a signed-in session): [Leah Wang](https://www.linkedin.com/in/leah-wang-8676903a8/), [Nanqun Chen](https://www.linkedin.com/in/nanqunchen/), [Lucas Wu](https://www.linkedin.com/in/fan-lucas-wu/) · experience pages: [Nanqun Chen](https://www.linkedin.com/in/nanqunchen/details/experience/), [Lucas Wu](https://www.linkedin.com/in/fan-lucas-wu/details/experience/)
- [Linq — messaging infrastructure behind Karpo on iMessage](https://linqapp.com/) · [community page quoting MachinePulse](https://linqapp.com/community)
